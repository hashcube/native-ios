...
var IOS_ICON_SIZES = ['20', '40', '60', '80', '57', '72', '76', '114', '120', '144', '152', '167', '180', '1024'];
      ...
      if (iconPath) {
        ...
        tasks.push(exists(iconPath)
          .then(function (exists) {
            ...
            logger.log('Zainul Icons: Copying', appPathToString(iconPath), 'to', appPathToString(targetPath));
